        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <?php             
              ...
              $Colour=$_POST['Colour'];
              $quant=$_POST['quant'];
              $query="INSERT INTO items (itemno,ItemName,Description,brand,Colour,quant) VALUES ('$itemno','$ItemName','$Description','$brand', '$Colour', '$quant');";
              $result=mysqli_query($con,$query);
              if ($result)
              {
              echo "New Stationary Added Successfully!";
              header( "refresh:3;url=addnewbook.php" );
              }
              else {
