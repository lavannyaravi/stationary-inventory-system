        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $keyword=$_POST['key'];
              $result = mysqli_query($con,"SELECT * FROM items WHERE ItemName LIKE '%$keyword%' OR brand LIKE '%$keyword%' OR Description LIKE '%$keyword%'");
              ...
              echo "No such items found... Try with another keyword";
