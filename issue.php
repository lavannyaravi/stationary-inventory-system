          ...
          <div class="panel panel-default">
            ...
            <?php
              ...
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td><a href=\"issue_insert.php?itemno=$row[itemno]&username=$row[username]\">Approve</a></td>";
                echo "<td><a href=\"issue_reject.php?itemno=$row[itemno]&username=$row[username]\">Reject</a></td>";
                }
              echo "</table>";
