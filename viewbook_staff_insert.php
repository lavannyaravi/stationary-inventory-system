        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="viewbook_staff.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Stationary</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
              ...
              if(isset($_POST['update']))
                {
                  ...
                  $result = mysqli_query($con, "UPDATE items SET ItemName='$ItemName',Description='$Description',brand='$brand',Colour='$Colour',quant='$quant' WHERE itemno='$itemno'");
                  header("Location: viewbook_staff.php");
                }
            ?>
            ...
            ?>
                ...
                <form name="form1" method="post" action="viewbook_staff_insert.php">
                  <table border="0">
                    <tr> 
                      <td>ItemName</td>
