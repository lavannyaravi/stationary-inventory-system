...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="help_stu.php">Change Password</a></li>
            <li class="active"><a href="contact_stu.php">Contact</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">

            <a Welcome to Staff Dashboard</a>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You are inside the CONTACT tab of TDK-Lamda Stationary System</li>
          </ol>
      </div>
    </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-Description">Contact</h3>
            </div>
            <div class="panel-body">

              <br>
              <h3 style='color:green;'>TDK-Lambda Malaysia Sdn. Bhd. (Kuantan Plant)
              Lot2&3, Kawasan Perindustrian Bandar Baru Jaya Gading 26070 Kuantan,
              <br> Pahang Darul Makmur, MALAYSIA</h3> 
               <br><br>  <h4 style='color:green;'> TEL:+60-9-5382255</h4>
               <br>  <h4 style='color:green;'>  FAX:+60-9-5382206</h4>
              <br><br><br>
