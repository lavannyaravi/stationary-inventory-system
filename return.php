        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-Description">Return Register</h3>
            </div>
            <div class="panel-body">
              ...
              echo "No items issued yet!!! Call a student and issue some items !!!";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td>" . $row['date'] . "</td>";
                echo "<td> <form action='return_confirm.php' method='POST'><input type='hidden' name='itemno' value='".$row["itemno"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Return' /></form></td></tr>";
                }
              echo "</table>";
              mysqli_close($con);
              ?>
