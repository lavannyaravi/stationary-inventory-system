        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <?php
              ...
              $result = mysqli_query($con, "UPDATE requests,items SET requests.status='Rejected', items.quant='$newtotal' WHERE requests.itemno = items.itemno AND items.itemno='$itemno' AND requests.username='$username'");
