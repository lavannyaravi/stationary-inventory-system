...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You are inside the student dashboard of TDK-Lamda Stationary System</li>
          </ol>
      </div>
    </section>
    <section id="main">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="dashboard_stu.php" class="list-group-item active main-color-bg">
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-Description">Dashborad</h3>
            </div>
            <div class="panel-body">
            <h3> Welcome to Staff Dashboard of TDK-Lamda Stationary System. </h3><h4>Explore the tabs :)</h4>
