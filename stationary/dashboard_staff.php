        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="dashboard_staff.php" class="list-group-item active main-color-bg">
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <h3> Welcome to Admin Dashboard of TDK-LAMBDA Stationary System. </h3><h4>Explore the tabs :)</h4>
