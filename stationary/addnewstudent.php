      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="addnewstudent.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add a Staff</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <form method="post" action="addnewstudent_insert.php" onsubmit="return Validate()">
                <div class="form-group">
                  <label for="">Register Number</label>
                  <input type="text" class="form-control" id="" placeholder="Reg No" name="empno">
                </div>
                <div class="form-group">
                  <label for="">Staff Name</label>
                  <input type="text" class="form-control" id="" placeholder="Enter Staff Name" name="staff_name" required>
                </div>
                  <div class="form-group">
                  <label for="">Class</label>
                  <input type="text" class="form-control" id="" placeholder="Class Name" name="class" required>
                </div>
                <div class="form-group">
                  <label for="">Username</label>
                  <input type="text" class="form-control" id="" placeholder="User Name" name="stu_username" required>
                </div>
                <div class="form-group">
                  <label for="">Password</label>
                  <input type="password" class="form-control" id="p1" placeholder="Password" name="stu_password1" required>
                </div>
                <div class="form-group">
