        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $date=$_POST['date'];
              $rdate=$_POST['rdate'];
              $query="INSERT INTO issue_register VALUES ('$bid','$description','$empno','$staff_name','$date','$rdate');";
              ...
              $query="UPDATE items SET issued=1 where itemno=$bid;";
              $result = mysqli_query($con,$query);
              if($result)
              {
              ...
              {
                echo "Database Updation Error !!!Please try again...";
              }
              mysqli_close($con);
              ?>
            </div>
