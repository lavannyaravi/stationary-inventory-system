...
<html lang="en">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You are inside the HELP tab of TDK-LAMBDA Stationary System</li>
          </ol>
      </div>
    </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">HelpDesk</h3>
            </div>
            <div class="panel-body">
              <h3> Welcome to the HelpDesk of TDK-LAMBDA Stationary System. </h3>
              <br>
