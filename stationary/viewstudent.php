        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="viewstudent.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> View Staff</a>
            </div>
        </div>
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $result = mysqli_query($con,"SELECT * FROM login_staff");
              ...
              echo "Staff Database is empty!!! Go to Students tab and add a new product";
              while($row = mysqli_fetch_array($result))
                ...
                echo "<td>" . $row['staff_user'] . "</td>";
                echo "<td>" . $row['staff_password'] . "</td>";
                 echo "<td> <form action='delete_student.php' method='POST'><input type='hidden' name='id' value='".$row["id"]."'/><input type='submit' name='submit-btn' class='btn btn-default main-color-bg' value='Delete' /></form></td></tr>";
                }
              echo "</table>";
              mysqli_close($con);
              ?>
