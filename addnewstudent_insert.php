...
<?php
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
          <ol class="breadcrumb">
            <li class="active">You are inside the staff dashboard of FSKKP'S Stationary System</li>
          </ol>
      </div>
    </section>
    <section id="main">
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <?php             
              ...
              $dept=$_POST['dept'];
              $stu_user=$_POST['stu_username'];
              $stu_password=$_POST['stu_password1'];

              $query="INSERT INTO login_staff (id,empno,staff_name,class,staff_user,staff_password) VALUES (DEFAULT,'$empno','$name','$dept','$stu_user', '$stu_password');";
              $result=mysqli_query($con,$query);
              if ($result)
              {
              header( "refresh:3;url=addnewstudent.php" );
