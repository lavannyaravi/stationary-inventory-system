      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="addnewbook.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Add New Stationary</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <form method="post" action="addnewbook_insert.php" onsubmit="return Validate()">
                <div class="form-group">
                  <label for="">Stationary Number</label>
                  <input type="text" class="form-control" id="" placeholder="Stationary No" name="itemno">
                </div>
                <div class="form-group">
                  <label for="">ItemName</label>
                  <input type="text" class="form-control" id="" placeholder="Enter ItemName" name="ItemName" required>



                </div>
                  <div class="form-group">
                  <label for="">Stationary Name</label>
                  <input type="text" class="form-control" id="" placeholder="Description" name="Description" required>
                </div>
                <div class="form-group">
                  <label for="">Brand Name</label>
                  <input type="text" class="form-control" id="" placeholder="Brand" name="brand" required>
                </div>
                <div class="form-group">
                  <label for="">Colour Name</label>
                  <input type="text" class="form-control" id="" placeholder="Colour" name="Colour" required>
                </div>
                <div class="form-group">
                  <label for="">Total Quantity</label>
                  <input type="text" class="form-control" id="p1" placeholder="Total Quantity Available" name="quant" required>
                </div>
